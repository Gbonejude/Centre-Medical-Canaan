                ...
                <div class="col-md-7">
                    <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                        <div class="card-header bg-primary text-white p-4">
                            <h3 class="mb-1">Modifier le Rendez-vous</h3>
                            <p class="mb-0 opacity-75">Modifiez les informations de votre consultation.</p>
                        </div>
...
const form = useForm({
    medical_service_id: props.appointment.medical_service_id || "",
...
const submit = () => {
    ...
    form.put(route('front.appointments.update', props.appointment.uuid), {
        onSuccess: () => {
