<template>
    <Head>
        <title>Ajouter un Service | CMC</title>
        <meta name="description" content="Ajouter un nouveau service médical au système" />
    </Head>
            ...
            <div class="card form-card">
                <div class="card-header">
                    <div class="card-title">
                        <i class="fa fa-notes-medical icon-circle"></i>
                        <span>Nouveau Service Médical</span>
                    </div>
                    <p class="card-subtitle">Configurez un nouveau type de service ou consultation</p>
                </div>
                        ...
                        <div class="form-actions">
                            <div class="action-buttons">
                                ...
                                <button type="submit" class="btn btn-primary" :disabled="form.processing">
                                    ...
                                    <span>{{ form.processing ? 'Enregistrement...' : 'Enregistrer le Service' }}</span>
...
function save() {
    form.post(route("medical-services.store"), {
        onSuccess: () => {
