        ...
        <div class="container">
            ...
            <div class="card form-card">
                <div class="card-header">
                    ...
                    <p class="card-subtitle">Mettre à jour les informations et le rôle de l'utilisateur</p>
                </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="permissions-container">
                                <div class="permissions-title">
                                    ...
                                    <span>Gérer le rôle unique de l'utilisateur</span>
                                </div>
...
const form = useForm({
    ...
    selectedPermission: props.userPermissions?.[0] || null,
    password: '',
