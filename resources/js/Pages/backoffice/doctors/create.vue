<template>
    <Head>
        <title>Ajouter un Médecin | CMC</title>
        <meta name="description" content="Ajouter un nouveau médecin à l'équipe" />
    </Head>
        ...
        <div class="container">
            ...
            <div class="card form-card">
                <div class="card-header">
                    ...
                    <p class="card-subtitle">Enregistrez un nouveau membre de l'équipe médicale</p>
                </div>
                    ...
                    <form @submit.prevent="save" class="user-form">
                        ...
                        <div class="form-section">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="bio">Biographie / Notes</label>
                                        <textarea id="bio" class="form-control" rows="4" v-model="form.bio"
                                            placeholder="Présentation du médecin..."></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-actions mt-5">
                            <div class="action-buttons">
                                ...
                                <button type="submit" class="btn btn-primary" :disabled="form.processing">
                                    ...
                                    <span>{{ form.processing ? 'Enregistrement...' : 'Enregistrer le Médecin' }}</span>
                                </button>
                            </div>
                        </div>
                    </form>
