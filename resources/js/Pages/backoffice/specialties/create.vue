<template>
    <Head>
        <title>Nouvelle Spécialité | CMC</title>
    </Head>
            ...
            <div class="card form-card">
                <div class="card-header">
                    <div class="card-title">
                        <i class="fa fa-plus-circle icon-circle"></i>
                        <span>Créer une Spécialité</span>
                    </div>
                </div>
                    ...
                    <form @submit.prevent="save" class="user-form">
                        <div class="form-section">
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <input id="name" type="text" class="form-control"
                                        v-model="form.name" placeholder="Ex: Cardiologie, Pédiatrie..."
                            ...
                            <div class="form-group mt-4">
                                ...
                                <textarea id="description" class="form-control" rows="4"
                                    v-model="form.description" placeholder="Description de la spécialité..."></textarea>
                            </div>
                        ...
                        <div class="form-actions mt-5">
                            ...
                            <button type="submit" class="btn btn-primary" :disabled="form.processing">
                                {{ form.processing ? 'Enregistrement...' : 'Enregistrer la Spécialité' }}
                            </button>
                        </div>
                    </form>
                </div>
...
function save() {
    form.post(route("specialties.store"), {
        onSuccess: () => toast.success('Spécialité créée avec succès'),
    });
}
</script>
